...
![Output of a script using basic Python functions][Images/05 Basic functions]
...
![Output of a script using numpy and statistics libraries][Images/06 numpy]
...
![Histogram displaying the distribution of Sepal Length, Sepal Width, Petal Length and Petal Width][07 matplotlib]
...
![Repoprt using pandas 'describe' function][Images/08 report]

![Scatter plot of Petal length/Petal width][Images/08 scat petal]

![Scatter plot of Sepal length/Sepal width][Images/08 scat sepal]
